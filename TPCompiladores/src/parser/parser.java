...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Oct 30 11:20:30 ART 2014
  */
		  ...
		  Descriptor d = tds.search(i);
						if (d!=null)
							if (d.getClase().equals("descriptorArreglo"))
								RESULT = new VarLocation(i,d,ileft,iright,false); 
							else
...
tds.push(new Ambiente()) ; putParameters();
		...
		int bright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 b.setMethodName(i); parser.asts.add(b); 
...
params = p;
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 b.setMethodName(i); parser.asts.add(b);   
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,b,new DescriptorFuncion(i,Type.VOID,null),ileft,iright) ;
							else 
								parser.report_fatal_error("Metodo redeclarado",ileft,iright); 
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 b.setMethodName(i);
					    parser.asts.add(b);  
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,b,new DescriptorFuncion(i,t,null),ileft,iright) ;
							else
								parser.report_fatal_error("Metodo redeclarado",ileft,iright); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("method",14, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
		...
		IntLiteral il = (IntLiteral)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
						...
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,new DescriptorArreglo(i,tipoVar,il.getValue()),ileft,iright,true) ;
							else
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,new DescriptorSimple(i,tipoVar),ileft,iright,true) ;
							else
								parser.report_fatal_error("Variable redeclarada",ileft,iright);
