...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Oct 04 15:53:33 ART 2014
  */
      ...
      switch (CUP$parser$act_num)
		  ...
		  Descriptor d = tds.search(i);
						if (d!=null)
							if (d.getClase().equals("descriptorArreglo"))
								RESULT = new VarLocation(i,d,ileft,iright); 
							else
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		 Descriptor d = tds.search(i);
										if (d!=null)
											if (d.getClase().equals("descriptorFuncion"))
												RESULT = new MethodCall(i,d.getTipo(),null,ileft,iright) ;
											else
												parser.report_fatal_error("Funcion no declarada",ileft,iright);		
										else
											parser.report_fatal_error("Los tipos no concuerdan",ileft,iright); 
		...
		int eright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = new AssignStmt(loc,aop,e,locleft,locright) ; 
...
tds.push(new Ambiente()) ; putParameters();
		...
		int iright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  p.add(new DescriptorSimple(i,t,DescriptorSimple.getOffset()+4));
											RESULT = p ; 
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 LinkedList<DescriptorSimple> l = new LinkedList<DescriptorSimple>() ;
								l.add(new DescriptorSimple(i,t,DescriptorSimple.getOffset()+4));
								RESULT = l; 
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  parser.asts.add(b); 
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,b,new DescriptorFuncion(i,t,p,DescriptorFuncion.getOffset()+4),ileft,iright) ;
							else
...
params = p;
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  parser.asts.add(b); 
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,b,new DescriptorFuncion(i,Type.VOID,p,DescriptorFuncion.getOffset()+4),ileft,iright) ;
							else
								parser.report_fatal_error("Metodo redeclarado",ileft,iright);
						params = null; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("method",14, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-6)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
...
params = p;
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 parser.asts.add(b);   
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,b,new DescriptorFuncion(i,Type.VOID,null,DescriptorFuncion.getOffset()+4),ileft,iright) ;
							else 
								parser.report_fatal_error("Metodo redeclarado",ileft,iright); 
		...
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
					    ...
					    parser.asts.add(b);  
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,b,new DescriptorFuncion(i,t,null,DescriptorFuncion.getOffset()+4),ileft,iright) ;
							else
								parser.report_fatal_error("Metodo redeclarado",ileft,iright); 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("method",14, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
		...
		IntLiteral il = (IntLiteral)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
						...
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,new DescriptorArreglo(i,tipoVar,il.getValue(),DescriptorArreglo.getOffset()+4*il.getValue()),ileft,iright) ;
							else
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,new DescriptorSimple(i,tipoVar,DescriptorSimple.getOffset()+4),ileft,iright) ;
							else
								parser.report_fatal_error("Variable redeclarada",ileft,iright);
