...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sat Sep 27 17:41:58 ART 2014
  */
...
params = p;
		...
		IntLiteral il = (IntLiteral)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
						...
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,new DescriptorArreglo(i,tipoVar,il.getValue()),ileft,iright) ;
							else
		...
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						if (tds.top().get(i)==null)
								RESULT = new VarLocation(i,new DescriptorSimple(i,tipoVar),ileft,iright) ;
							else
								parser.report_fatal_error("Variable redeclarada",ileft,iright);
