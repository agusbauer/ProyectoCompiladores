...
public class VarLocation extends Location {
    ...
    public VarLocation(String id, Descriptor d, int line, int col, boolean isdecl) {
        if (isdecl){ //para diferenciar el caso de la declaracion del caso de  la asignacion
            if (d.getClase().equals("descriptorSimple")) {
