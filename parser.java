...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Sep 17 12:03:01 ART 2014
  */
...
t.push(new Ambiente()) ;
          ...
          case 20: // parameters ::= parameters COMMA type id 
            {
              LinkedList<Descriptor> RESULT =null;
		int pleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int pright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		LinkedList<Descriptor> p = (LinkedList<Descriptor>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		...
		int iright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		String i = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 LinkedList<> l = new LinkedList<DescriptorSimple>() ;
		...
		LinkedList<Descriptor> p = (LinkedList<Descriptor>)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		int bleft = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int bright = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		Block b = (Block)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		  Descriptor d = t.search(i);
		...
		Location m = (Location)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 t.top().put(m.getId(),m.getDesc()) ;
		...
		IntLiteral il = (IntLiteral)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		  Descriptor d = t.search(i);
						if (d==null)
								RESULT = new VarLocation(i,new DescriptorArreglo(i,tipoVar,il)) ;
							else
								System.out.println("ERROR: Variable redeclarada"); 
